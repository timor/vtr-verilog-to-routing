...
input c_we;
input [13:0] a_reg; //segfault fix
input [13:0] b_reg; //segfault fix
input [13:0] c_reg; //segfault fix
...
input [13:0] boot_iaddr; //segfault fix
input [31:0] boot_idata;
input boot_iwe;
...
input [14:0] boot_daddr; //segfault fix
input [31:0] boot_ddata;
input boot_dwe;
...
input squashn;
input [31:0] d;
output [31:0] q; //segfault fix
reg [31:0] r; //segfault fix
...
begin
  ...
  begin
    r[5:0]<=d; //segfault fix
	r[31:6] <= 0; //segfault fix
...
begin
  if (resetn==0 || squashn==0)
   ...
   begin
    r[4:0]<=d; //segfault fix
	r[31:5] <= 0; //segfault fix
